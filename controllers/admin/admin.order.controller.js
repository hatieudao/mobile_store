...
const orderDetailService = require('../../services/admin/admin.orderDetail.service');
...
exports.orderItem = async (req, res) => {
    ...
    res.render('admin/order/orderItem', { title: `Order ${id}`, layout: 'admin/layout.hbs', order, orderDetails, countOrderDetails, countOrderByUserId});
}
